...
st.write('The quantitative analysis of the Magnificent 7 stocks involves the application of mathematical and statistical techniques to evaluate their historical performance, volatility, and potential future trends. The analysis was carried out using the last 5 years daily closing prices of the stocks')
...
st.subheader('2. Descriptive statistics of the magnificent 7 stocks')
...
st.subheader('3. Average daily return of The magnificent 7 stocks')
...
st.subheader('5. Volatility of the magnificent 7 stocks')
...
st.subheader('6. Correlation of The magnificent 7 stocks')
